...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Database = shaluhin; Username = shaluhin; Host = 45.67.56.214:5454; Password = yniBvADq; Port = 5454");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Clientservice>(entity =>
        {
            ...
            entity.ToTable("clientservice", "demo");
        ...
        modelBuilder.Entity<Documentbyservice>(entity =>
        {
            ...
            entity.ToTable("documentbyservice", "demo");
        ...
        modelBuilder.Entity<Productphoto>(entity =>
        {
            ...
            entity.ToTable("productphoto", "demo");
        ...
        modelBuilder.Entity<Servicephoto>(entity =>
        {
            ...
            entity.ToTable("servicephoto", "demo");
